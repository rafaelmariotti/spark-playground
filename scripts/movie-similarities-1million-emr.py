...
def load_movie_names():
    with open("dataset/ml-1m/movies.dat", encoding="ISO-8859-1") as file:
        movie_name = {}
        for line in file:
            fields = line.split("::")
...
spark_file = sc.textFile("s3://sundog-spark/ml-1m/ratings.dat")
...
ratings_combined = ids_and_ratings.partitionBy(100)
...
movie_pairs = ratings_combined_without_duplicate.map(create_pair).partitionBy(100)
